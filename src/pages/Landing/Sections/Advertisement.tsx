...
export const OverallAd = () => {
  ...
  return (
    <BottomBarAnimation
      ...
      <TopBarAnimation
        className='z-[800] hidden p-2 sm:block'
        threshold={9}
        content={
          <div className='w-full  rounded-l px-2 py-8 font-montserrat dark:bg-slate-800'>
        ...
        <PageSection className=''>
          <div className="my-auto md:flex">
            <div className="relative mx-auto h-fit w-full md:mx-0 md:w-1/3">
              ...
              ></div>
              <div className={'absolute left-0 top-0  z-0 h-full border-l-2 border-gray-500'}></div>
