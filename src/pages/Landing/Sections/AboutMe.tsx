...
export const AboutMe = () => {
  ...
  return (
    <PageSection className="flex flex-wrap gap-12 transition-all duration-300 md:flex-nowrap">
      <div className="">
        <img
          src="https://access-portfolio-images.s3.amazonaws.com/memoji.jpg"
          alt="Devin"
          className=" m-auto block max-w-64 rounded-full border-b-4 border-blue-300 object-cover shadow dark:border-red-500/70 md:size-60"
        />
        <div className="-my-5 rounded border-b-2 border-r-2 border-blue-300 bg-white/40 p-2 backdrop-blur dark:border-red-500/70 dark:bg-gray-800/10">
          ...
          <div className="flex justify-center gap-2">
            <a
              ...
              className="rounded-full bg-slate-300 p-1 transition-all hover:scale-110"
            >
      ...
      <div className="my-auto flex flex-col gap-y-2 md:w-2/3">
        ...
        <SubTitle className=" flex flex-col gap-y-2">
          {!tldr && (
            <span>
              Welcome to my portfolio website, where I invite you to embark on a
              journey through my passion for technology and innovation.
            </span>
          )}
          <span>
            As a dedicated fullstack software engineer, I've had the privilege
            of crafting digital solutions that bridge the gap between
            imagination and reality.
          </span>
          {!tldr && (
            <span>
              Here, you'll find a curated collection of my work, a testament to
              my commitment to creating seamless, efficient, and user-centric
              software.
            </span>
          )}
        </SubTitle>
        <SubTitle className="flex flex-col gap-y-3">
          <span>
            From the front-end's aesthetic appeal to the back-end's robust
            functionality, my portfolio showcases the diverse range of projects
            I've had the pleasure of working on. Each project is a testament to
            my problem-solving skills, attention to detail, and relentless
            pursuit of excellence in software development.
          </span>
          {/* 
          {
            !tldr && (
