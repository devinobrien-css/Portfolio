    ...
    <div className="my-32 min-h-screen">
      ...
      <div className="flex flex-wrap gap-4">
        <div className="dark:shadow-slate-80 md:w-1/20 w-full rounded bg-white p-4 shadow dark:bg-slate-800 lg:w-[22%]">
          <Icon
            icon="ph:code-thin"
            className="size-12 text-blue-500 dark:text-red-500"
          />
          <h3 className="my-2 font-montserrat dark:text-moonstone">
            Front End Development
          </h3>

          <p className=" font-lato text-sm dark:text-tiffany-blue">
            Building responsive, and accessible apps using modern front end
            technologies.
          </p>
        </div>
        ...
        <div className="dark:shadow-slate-80 md:w-1/20 w-full rounded bg-white p-4 shadow dark:bg-slate-800 lg:w-[22%]">
          ...
          <p className="font-lato text-sm dark:text-tiffany-blue">
            Writing scalable, efficient, and secure server-side code to power
            web applications.
          </p>
        </div>
        ...
        <div className="dark:shadow-slate-80 md:w-1/20 w-full rounded bg-white p-4 shadow dark:bg-slate-800 lg:w-[22%]">
          ...
          <p className="font-lato text-sm dark:text-tiffany-blue">
            Building mobile applications for iOS and Android using modern
            technologies.
          </p>
        </div>
        ...
        <div className="dark:shadow-slate-80 md:w-1/20 w-full rounded bg-white p-4 shadow dark:bg-slate-800 lg:w-[22%]">
          ...
          <p className="font-lato text-sm dark:text-tiffany-blue">
            Architecting scalable and reliable infrastructure to support
            applications.
          </p>
        </div>
