...
export const frontend_tags = [
  'Angular', 'React', 'Svelte', 'Typescript', 'Javascript', // 'Vue',
];
export const backend_tags = [
  'Python', 'Go', 'C#', 'Flask', 'GraphQL', 'Apollo Server', 'Node', 'Express', //'Django'
];
export const cloud_tags = [
  'AWS', 'CDK', 'Amplify' // 'GCP', 'Azure', 
];
export const database_tags = [
  'PostgreSQL', 'SQL Server', 'DynamoDB', // 'MongoDB', 'MySQL', 'SQLite'
];
export const devops_tags = [
  'Docker', 'Netlify', //'Github Actions', 
];
export const design_tags = [
  'CSS', 'SCSS', 'Tailwind', //'Bootstrap', 'Material UI'
];
// const other_tags = [
...
export const projects: GithubProject[] = [
  ...
  },
  {
    ...
    image: 'https://access-portfolio-images.s3.amazonaws.com/apollo-react-bg.jpeg',
  ...
  },
  {
    ...
    image: 'https://access-portfolio-images.s3.amazonaws.com/logistic-regression-bg.jpeg',
